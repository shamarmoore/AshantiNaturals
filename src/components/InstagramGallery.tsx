      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-stone-600 max-w-2xl mx-auto">
            See how our community styles their Ashanti Naturals hair
          </p>
        </div>
            ...
            >
              ...
              <div className="absolute inset-0 bg-stone-900/0 group-hover:bg-stone-900/60 transition-all duration-300 flex items-center justify-center">
                <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-center text-white">
                  ...
                  <p className="text-sm font-medium">Follow @ashantiNaturals</p>
                </div>
              </div>
            </a>
          ))}
        ...
        <div className="text-center mt-10">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-600 to-orange-500 text-white font-semibold rounded-full
                       hover:from-amber-700 hover:to-orange-600 transition-all duration-300 shadow-md hover:shadow-lg"
          >
